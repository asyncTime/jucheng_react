...
import "../assets/liu/css/yangshi.css";
...
class Show extends Component {
    ...
    navClick(id,e){
       ...
       this.props.getShowList({id,cityId:this.state.cityId,page:1});
        this.setState({
            navId:id,
            page:2
        });
    ...
    render() {
        ...
        const showList=this.props.showList.showList?this.props.showList.showList:[];
        ...
        return (
            <div  className="lables">
                ...
                <div className="lablesValue">
                    {
                        showList.map((v,i)=>(
                            <NavLink to={`/ShowDetal/${v.schedular_id}`} key={i}>
    ...
    pullLoading(){
        ...
        window.onscroll=function () {
            ...
            if(scrollHeight-scrollTops<clientHeight){
                _me.props.getShowList({id:_me.state.navId,cityId:_me.state.cityId,page:_me.state.page++});
            }
        }
    }
    componentDidMount(){
    ...
    init(){
       ...
       this.props.getShowList({id:this.props.match.params.id,cityId:0});
        pubsub.subscribe("cityIds",(Name,cityId)=>{

            const navId=cityId.cityId.navId
            const city=cityId.cityId.cityId
           this.props.getShowList({id:navId,cityId:city,page:1});
            this.setState({
                cityId:city
            });
        })
